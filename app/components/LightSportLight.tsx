...
const LightSportLight = () => {
  return (
    <div className='hidden sm:block'>
        <div className="container py-4 my-5 bg-gray-200">
            ...
            <div className="flex flex-wrap justify-center">
                ...
                <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/5 p-2">
                    <div className='bg-white p-2'>
                        ...
                        <button className="text-white bg-black hover:bg-black-700 py-2 px-5 rounded"> Take Flight Collection </button>
                    </div>
                </div>
...
export default LightSportLight